...
impl SPI1_START_BUSY_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, SPI1_START_BUSY_A> {
        use crate::Variant::*;
        match self.bits {
            false => Val(SPI1_START_BUSY_A::SPI1_IDLE),
            true => Val(SPI1_START_BUSY_A::SPI1_START),
            true => Val(SPI1_START_BUSY_A::SPI1_BUSY),
            i => Res(i),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `SPI1_BUSY`"]
    #[inline(always)]
    pub fn is_spi1_busy(&self) -> bool {
        *self == SPI1_START_BUSY_A::SPI1_BUSY
    }
}
...
impl<'a> SPI1_START_BUSY_W<'a> {
    ...
    #[doc = "Indicate that the SPI interface is currently transferring data"]
    #[inline(always)]
    pub fn spi1_busy(self) -> &'a mut W {
        self.variant(SPI1_START_BUSY_A::SPI1_BUSY)
    }
