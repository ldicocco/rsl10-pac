...
impl SPI1_TRANSMIT_STATUS_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> SPI1_TRANSMIT_STATUS_A {
        match self.bits {
            false => SPI1_TRANSMIT_STATUS_A::SPI1_TRANSMIT_FALSE,
            true => SPI1_TRANSMIT_STATUS_A::SPI1_TRANSMIT_TRUE,
        }
    }
...
impl SPI1_RECEIVE_STATUS_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SPI1_RECEIVE_STATUS_A {
        match self.bits {
            false => SPI1_RECEIVE_STATUS_A::SPI1_RECEIVE_FALSE,
            true => SPI1_RECEIVE_STATUS_A::SPI1_RECEIVE_TRUE,
        }
    }
...
impl SPI1_OVERRUN_STATUS_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SPI1_OVERRUN_STATUS_A {
        match self.bits {
            false => SPI1_OVERRUN_STATUS_A::SPI1_OVERRUN_FALSE,
            true => SPI1_OVERRUN_STATUS_A::SPI1_OVERRUN_TRUE,
        }
    }
...
impl SPI1_UNDERRUN_STATUS_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> SPI1_UNDERRUN_STATUS_A {
        match self.bits {
            false => SPI1_UNDERRUN_STATUS_A::SPI1_UNDERRUN_FALSE,
            true => SPI1_UNDERRUN_STATUS_A::SPI1_UNDERRUN_TRUE,
        }
    }
