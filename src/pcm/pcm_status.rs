...
pub enum TRANSMIT_STATUS_A {
    ...
    PCM_TRANSMIT_TRUE = 1,
    #[doc = "1: Clear the PCM transmit status bit"]
    PCM_TRANSMIT_CLEAR = 1,
}
...
impl TRANSMIT_STATUS_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, TRANSMIT_STATUS_A> {
        use crate::Variant::*;
        match self.bits {
            false => Val(TRANSMIT_STATUS_A::PCM_TRANSMIT_FALSE),
            true => Val(TRANSMIT_STATUS_A::PCM_TRANSMIT_TRUE),
            true => Val(TRANSMIT_STATUS_A::PCM_TRANSMIT_CLEAR),
            i => Res(i),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `PCM_TRANSMIT_CLEAR`"]
    #[inline(always)]
    pub fn is_pcm_transmit_clear(&self) -> bool {
        *self == TRANSMIT_STATUS_A::PCM_TRANSMIT_CLEAR
    }
}
...
impl<'a> TRANSMIT_STATUS_W<'a> {
    ...
    #[doc = "Clear the PCM transmit status bit"]
    #[inline(always)]
    pub fn pcm_transmit_clear(self) -> &'a mut W {
        self.variant(TRANSMIT_STATUS_A::PCM_TRANSMIT_CLEAR)
    }
...
pub enum RECEIVE_STATUS_A {
    ...
    PCM_RECEIVE_TRUE = 1,
    #[doc = "1: Clear the PCM receive status bit"]
    PCM_RECEIVE_CLEAR = 1,
}
...
impl RECEIVE_STATUS_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, RECEIVE_STATUS_A> {
        use crate::Variant::*;
        match self.bits {
            false => Val(RECEIVE_STATUS_A::PCM_RECEIVE_FALSE),
            true => Val(RECEIVE_STATUS_A::PCM_RECEIVE_TRUE),
            true => Val(RECEIVE_STATUS_A::PCM_RECEIVE_CLEAR),
            i => Res(i),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `PCM_RECEIVE_CLEAR`"]
    #[inline(always)]
    pub fn is_pcm_receive_clear(&self) -> bool {
        *self == RECEIVE_STATUS_A::PCM_RECEIVE_CLEAR
    }
}
...
impl<'a> RECEIVE_STATUS_W<'a> {
    ...
    #[doc = "Clear the PCM receive status bit"]
    #[inline(always)]
    pub fn pcm_receive_clear(self) -> &'a mut W {
        self.variant(RECEIVE_STATUS_A::PCM_RECEIVE_CLEAR)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub enum OVERRUN_STATUS_A {
    ...
    PCM_OVERRUN_TRUE = 1,
    #[doc = "1: Clear the PCM overrun bit"]
    PCM_OVERRUN_CLEAR = 1,
}
...
impl OVERRUN_STATUS_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, OVERRUN_STATUS_A> {
        use crate::Variant::*;
        match self.bits {
            false => Val(OVERRUN_STATUS_A::PCM_OVERRUN_FALSE),
            true => Val(OVERRUN_STATUS_A::PCM_OVERRUN_TRUE),
            true => Val(OVERRUN_STATUS_A::PCM_OVERRUN_CLEAR),
            i => Res(i),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `PCM_OVERRUN_CLEAR`"]
    #[inline(always)]
    pub fn is_pcm_overrun_clear(&self) -> bool {
        *self == OVERRUN_STATUS_A::PCM_OVERRUN_CLEAR
    }
}
...
impl<'a> OVERRUN_STATUS_W<'a> {
    ...
    #[inline(always)]
    pub fn pcm_overrun_clear(self) -> &'a mut W {
        self.variant(OVERRUN_STATUS_A::PCM_OVERRUN_CLEAR)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
pub enum UNDERRUN_STATUS_A {
    ...
    PCM_UNDERRUN_TRUE = 1,
    #[doc = "1: Clear the PCM underrun bit"]
    PCM_UNDERRUN_CLEAR = 1,
}
...
impl UNDERRUN_STATUS_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, UNDERRUN_STATUS_A> {
        use crate::Variant::*;
        match self.bits {
            false => Val(UNDERRUN_STATUS_A::PCM_UNDERRUN_FALSE),
            true => Val(UNDERRUN_STATUS_A::PCM_UNDERRUN_TRUE),
            true => Val(UNDERRUN_STATUS_A::PCM_UNDERRUN_CLEAR),
            i => Res(i),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `PCM_UNDERRUN_CLEAR`"]
    #[inline(always)]
    pub fn is_pcm_underrun_clear(&self) -> bool {
        *self == UNDERRUN_STATUS_A::PCM_UNDERRUN_CLEAR
    }
}
...
impl<'a> UNDERRUN_STATUS_W<'a> {
    ...
    #[inline(always)]
    pub fn pcm_underrun_clear(self) -> &'a mut W {
        self.variant(UNDERRUN_STATUS_A::PCM_UNDERRUN_CLEAR)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
