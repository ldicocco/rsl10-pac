...
impl SPI0_TRANSMIT_STATUS_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, SPI0_TRANSMIT_STATUS_A> {
        use crate::Variant::*;
        match self.bits {
            false => Val(SPI0_TRANSMIT_STATUS_A::SPI0_TRANSMIT_FALSE),
            true => Val(SPI0_TRANSMIT_STATUS_A::SPI0_TRANSMIT_TRUE),
            true => Val(SPI0_TRANSMIT_STATUS_A::SPI0_TRANSMIT_CLEAR),
            i => Res(i),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `SPI0_TRANSMIT_CLEAR`"]
    #[inline(always)]
    pub fn is_spi0_transmit_clear(&self) -> bool {
        *self == SPI0_TRANSMIT_STATUS_A::SPI0_TRANSMIT_CLEAR
    }
}
...
impl<'a> SPI0_TRANSMIT_STATUS_W<'a> {
    ...
    #[inline(always)]
    pub fn spi0_transmit_clear(self) -> &'a mut W {
        self.variant(SPI0_TRANSMIT_STATUS_A::SPI0_TRANSMIT_CLEAR)
    }
...
impl SPI0_RECEIVE_STATUS_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, SPI0_RECEIVE_STATUS_A> {
        use crate::Variant::*;
        match self.bits {
            false => Val(SPI0_RECEIVE_STATUS_A::SPI0_RECEIVE_FALSE),
            true => Val(SPI0_RECEIVE_STATUS_A::SPI0_RECEIVE_TRUE),
            true => Val(SPI0_RECEIVE_STATUS_A::SPI0_RECEIVE_CLEAR),
            i => Res(i),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `SPI0_RECEIVE_CLEAR`"]
    #[inline(always)]
    pub fn is_spi0_receive_clear(&self) -> bool {
        *self == SPI0_RECEIVE_STATUS_A::SPI0_RECEIVE_CLEAR
    }
}
...
impl<'a> SPI0_RECEIVE_STATUS_W<'a> {
    ...
    #[inline(always)]
    pub fn spi0_receive_clear(self) -> &'a mut W {
        self.variant(SPI0_RECEIVE_STATUS_A::SPI0_RECEIVE_CLEAR)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl SPI0_OVERRUN_STATUS_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, SPI0_OVERRUN_STATUS_A> {
        use crate::Variant::*;
        match self.bits {
            false => Val(SPI0_OVERRUN_STATUS_A::SPI0_OVERRUN_FALSE),
            true => Val(SPI0_OVERRUN_STATUS_A::SPI0_OVERRUN_TRUE),
            true => Val(SPI0_OVERRUN_STATUS_A::SPI0_OVERRUN_CLEAR),
            i => Res(i),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `SPI0_OVERRUN_CLEAR`"]
    #[inline(always)]
    pub fn is_spi0_overrun_clear(&self) -> bool {
        *self == SPI0_OVERRUN_STATUS_A::SPI0_OVERRUN_CLEAR
    }
}
...
impl<'a> SPI0_OVERRUN_STATUS_W<'a> {
    ...
    #[inline(always)]
    pub fn spi0_overrun_clear(self) -> &'a mut W {
        self.variant(SPI0_OVERRUN_STATUS_A::SPI0_OVERRUN_CLEAR)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
...
impl SPI0_UNDERRUN_STATUS_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, SPI0_UNDERRUN_STATUS_A> {
        use crate::Variant::*;
        match self.bits {
            false => Val(SPI0_UNDERRUN_STATUS_A::SPI0_UNDERRUN_FALSE),
            true => Val(SPI0_UNDERRUN_STATUS_A::SPI0_UNDERRUN_TRUE),
            true => Val(SPI0_UNDERRUN_STATUS_A::SPI0_UNDERRUN_CLEAR),
            i => Res(i),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `SPI0_UNDERRUN_CLEAR`"]
    #[inline(always)]
    pub fn is_spi0_underrun_clear(&self) -> bool {
        *self == SPI0_UNDERRUN_STATUS_A::SPI0_UNDERRUN_CLEAR
    }
}
...
impl<'a> SPI0_UNDERRUN_STATUS_W<'a> {
    ...
    #[inline(always)]
    pub fn spi0_underrun_clear(self) -> &'a mut W {
        self.variant(SPI0_UNDERRUN_STATUS_A::SPI0_UNDERRUN_CLEAR)
    }
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
