...
pub enum UART_RX_OVERRUN_STATUS_A {
    ...
    #[doc = "1: Clear the RX overrun status bit"]
    UART_RX_OVERRUN_CLEAR = 1,
}
...
impl UART_RX_OVERRUN_STATUS_R {
    ...
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<bool, UART_RX_OVERRUN_STATUS_A> {
        use crate::Variant::*;
        match self.bits {
            false => Val(UART_RX_OVERRUN_STATUS_A::UART_RX_OVERRUN_FALSE),
            true => Val(UART_RX_OVERRUN_STATUS_A::UART_RX_OVERRUN_TRUE),
            true => Val(UART_RX_OVERRUN_STATUS_A::UART_RX_OVERRUN_CLEAR),
            i => Res(i),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `UART_RX_OVERRUN_CLEAR`"]
    #[inline(always)]
    pub fn is_uart_rx_overrun_clear(&self) -> bool {
        *self == UART_RX_OVERRUN_STATUS_A::UART_RX_OVERRUN_CLEAR
    }
}
...
impl<'a> UART_RX_OVERRUN_STATUS_W<'a> {
    ...
    #[inline(always)]
    pub fn uart_rx_overrun_clear(self) -> &'a mut W {
        self.variant(UART_RX_OVERRUN_STATUS_A::UART_RX_OVERRUN_CLEAR)
    }
